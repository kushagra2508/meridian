...
const script: ScriptStep[] = [
  ...
  },
  {
    ...
    build: () => ({
      ...
      ref: 'tool-slip',
      status: 'ok',
      summary: 'Delay 14 months (nper) to keep the original target',
    }),
  },
  {
    delay: 400,
  ...
  },
  {
    ...
    build: () => ({
      ...
      ref: 'tool-shrink',
      status: 'ok',
      summary: 'Reachable by date INR 4,398,702',
    }),
  },
  {
    delay: 400,
  ...
  },
  {
    ...
    build: () => ({
      ...
      ref: 'tool-topup',
      status: 'ok',
      summary: 'Additional SIP INR 4,820 / mo',
    }),
  },
  {
    delay: 400,
    build: () => ({
      ...
      at: clockLabel(),
      name: 'price_options',
      args: 'options=[slip,shrink,topup]',
      status: 'running',
    }),
  },
  {
  ...
  },
  {
    ...
    build: () => ({
      ...
      report: {
        ...
        metrics: [
          { label: 'Slip delay', value: '14 mo' },
          { label: 'Reachable target', value: 'INR 4,398,702' },
          { label: 'Top-up / mo', value: 'INR 4,820' },
          { label: 'Lowest friction', value: 'shrink_target' },
        ],
        bullets: [
          'slip_year: +14 months, original INR 5,000,000',
          'shrink_target: INR 4,398,702 by year 7',
          'monthly_topup: +INR 4,820 / mo',
        ],
      },
    }),
  },
  ...
  },
  {
    ...
    build: () => ({
      ...
      ref: 'tool-elig',
      status: 'ok',
      summary: 'Highest lane: mf_advisory (below PMS 50L)',
    }),
  },
  {
    delay: 400,
  ...
  },
  {
    ...
    build: () => ({
      ...
      ref: 'tool-ledger',
      status: 'ok',
      summary: 'Best path: shrink_target',
    }),
  },
  {
    delay: 400,
  ...
  },
  {
    ...
    build: () => ({
      ...
      ref: 'tool-prose',
      status: 'ok',
      summary: 'Four stances + ranked recommendation written',
    }),
  },
  {
    delay: 500,
    build: () => ({
      ...
      report: {
        ...
        verdict: 'shrink_target',
        metrics: [
          { label: 'Best path', value: 'shrink_target' },
          { label: 'Eligible lane', value: 'mf_advisory' },
        ],
        bullets: [
          'Ranked: shrink_target over monthly_topup and slip_year on net rupee claims.',
          'Adviser blurb: keep the date, accept the smaller tuition figure, stay in MF products.',
          'recommend: shrink_target',
          'caution: monthly_topup',
        ],
      },
    }),
  },
